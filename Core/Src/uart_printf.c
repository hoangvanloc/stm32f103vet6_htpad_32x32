...
void uart_start_receive(void)
{
	...
	HAL_UARTEx_ReceiveToIdle_DMA(&huart1, uart.buf_dma, UART_BUF_SIZE);
	__HAL_DMA_DISABLE_IT(&hdma_usart1_rx, DMA_IT_HT); // Optional: disable half-transfer interrupt
}
